...
# 변수 설정
NGHTTP2_DOWNLOAD_URL="http://repo.local/sources/nghttp2-1.68.1.tar.gz"
NGHTTP2_TAR="nghttp2-1.68.1.tar.gz"
NGHTTP2_DIR="nghttp2-1.68.1"
APACHE_DOWNLOAD_URL="http://repo.local/sources/httpd-2.4.67.tar.gz"
APACHE_SHA256_URL="http://repo.local/sources/httpd-2.4.67.tar.gz.sha256"
APACHE_TAR="httpd-2.4.67.tar.gz"
APACHE_DIR="httpd-2.4.67"
APR_DOWNLOAD_URL="http://repo.local/sources/apr-1.7.6.tar.gz"
APR_UTIL_DOWNLOAD_URL="http://repo.local/sources/apr-util-1.6.3.tar.gz"
